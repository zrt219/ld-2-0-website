...
export function MobileStickyCTA() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 border-t border-[rgba(198,165,92,0.4)] bg-[rgba(23,20,18,0.94)] p-2 text-sm font-bold uppercase text-[var(--ivory)] shadow-2xl backdrop-blur md:hidden">
      <Link
        href="/media"
