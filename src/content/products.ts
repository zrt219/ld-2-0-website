// Auto-generated curated product data with exact image-to-title visual matching
// Total Products: 72 across 6 Brand Categories
...
export const collectionProducts = getAllProducts();
